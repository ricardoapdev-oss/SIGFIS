import { PrismaClient, UserRole, UserStatus, ProcessStatus, ContractStatus, FiscalRole, OccurrenceSeverity, OccurrenceStatus, MeasurementStatus, AlterationType, AlterationStatus, AlertType, PhaseStatus } from '@prisma/client';
...
async function main() {
  ...
  const usersData = [
    { key: 'admin',  name: 'Ricardo Augusto',                  email: 'ricardo.peixoto@iquego.com.br', pw: '160212', role: UserRole.ADMIN,       reg: '30072'    },
    { key: 'alta1',  name: 'Diretoria de Administração',        email: 'alta@sigecontratos.com',         pw: '123456', role: UserRole.ALTA_GESTAO, reg: 'IQG-0003' },
    { key: 'alta2',  name: 'Lais de Castro Viana',              email: 'lais.viana@iquego.com.br',       pw: '123456', role: UserRole.ALTA_GESTAO, reg: 'IQG-0001' },
    { key: 'gestor', name: 'Jairo Vicente de Melo',             email: 'jairo.vicente@iquego.com.br',    pw: '123',    role: UserRole.GESTOR,      reg: 'IQG-0002' },
    { key: 'f01',    name: 'Rogério B. da Silva',               email: 'f01@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1001' },
    { key: 'f02',    name: 'Maria do Carmo C. Silva',           email: 'f02@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1002' },
    { key: 'f03',    name: 'Edilson Martins Garcia',            email: 'f03@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1003' },
    { key: 'f04',    name: 'Eunice Maria C. Oliveira',          email: 'f04@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1004' },
    { key: 'f05',    name: 'Eliety Rodrigues Pereira',          email: 'f05@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1005' },
    { key: 'f06',    name: 'Weverson de Oliveira',              email: 'f06@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1006' },
    { key: 'f07',    name: 'Cleiton de Sá Silva',               email: 'f07@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1007' },
    { key: 'f08',    name: 'Robson Policeno de Rezende',        email: 'f08@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1008' },
    { key: 'f09',    name: 'Pedro Henrique Martins',            email: 'f09@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1009' },
    { key: 'f10',    name: 'Thalita Guaribaldine S. Guimaraes', email: 'f10@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1010' },
    { key: 'f11',    name: 'Fábio Gonçalves da Silva',          email: 'f11@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1011' },
    { key: 'f12',    name: 'Gabriel Moraes Godinho',            email: 'f12@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1012' },
    { key: 'f13',    name: 'Denize Morais',                     email: 'f13@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1013' },
    { key: 'f14',    name: 'Sabrina Maria Barbosa',             email: 'f14@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1014' },
    { key: 'f15',    name: 'Wenderson de Souza',                email: 'f15@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1015' },
    { key: 'f16',    name: 'Patrícia Sodré',                    email: 'f16@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1016' },
    { key: 'f17',    name: 'Vandeir Gonçalves da Silva',        email: 'f17@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1017' },
    { key: 'f18',    name: 'Alessandro dos Santos',             email: 'f18@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1018' },
    { key: 'f19',    name: 'Vera Lúcia Nunes',                  email: 'f19@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1019' },
    { key: 'f20',    name: 'Laurindo Damas da Silva Júnior',    email: 'f20@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1020' },
    { key: 'f21',    name: 'Emerson Ferreira dos Anjos',        email: 'f21@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1021' },
    { key: 'f22',    name: 'Dalmo Francisco da Costa',          email: 'f22@sigecontratos.com',          pw: '123456', role: UserRole.FISCAL,      reg: 'IQG-1022' },
  ];
  ...
  type ContractRow = {
    key: string; num: string; pk: string; ck: string; obj: string;
    iv: number; cv: number; sd: string; st: string; ed: string;
    dep: string; obs: string | null;
  };
    ...
    data: [
      {
        ...
        severity: OccurrenceSeverity.MEDIUM, status: OccurrenceStatus.RESOLVED,
      ...
      },
      {
        ...
        severity: OccurrenceSeverity.HIGH, status: OccurrenceStatus.OPEN,
  ...
  await prisma.inspectionMeasurement.createMany({
    data: [
      { contractId: CT['c01'], fiscalId: U.f01, periodStart: new Date('2026-01-02'), periodEnd: new Date('2026-02-28'), measurementValue: 64575, reportDescription: 'Exames periódicos — 1º bimestre 2026. Todos os laudos recebidos e conferidos.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-03-10T16:00:00Z'), createdAt: new Date('2026-03-05T11:00:00Z') },
      { contractId: CT['c01'], fiscalId: U.f01, periodStart: new Date('2026-03-01'), periodEnd: new Date('2026-04-30'), measurementValue: 64575, reportDescription: 'Exames periódicos — 2º bimestre 2026. Pendente análise das inconformidades.', status: MeasurementStatus.PENDING_GESTOR, createdAt: new Date('2026-05-20T17:30:00Z') },
      { contractId: CT['c04'], fiscalId: U.f04, periodStart: new Date('2025-12-01'), periodEnd: new Date('2026-01-31'), measurementValue: 123750, reportDescription: 'Benefícios Jan/2026. Créditos carregados conforme relação nominal.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-02-08T10:00:00Z'), createdAt: new Date('2026-02-05T09:00:00Z') },
      { contractId: CT['c14'], fiscalId: U.f13, periodStart: new Date('2026-02-01'), periodEnd: new Date('2026-03-31'), measurementValue: 80000, reportDescription: 'Telecomunicações — 1º bimestre 2026. NFs conferidas e serviços prestados regularmente.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-04-12T14:00:00Z'), createdAt: new Date('2026-04-08T11:00:00Z') },
      { contractId: CT['c06'], fiscalId: U.f06, periodStart: new Date('2026-03-01'), periodEnd: new Date('2026-04-30'), measurementValue: 51000, reportDescription: 'Portaria e vigilância — Mar-Abr/2026. Frequência e relatórios de ronda conferidos.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-05-15T16:00:00Z'), createdAt: new Date('2026-05-10T13:00:00Z') },
      { contractId: CT['c17'], fiscalId: U.f15, periodStart: new Date('2026-04-01'), periodEnd: new Date('2026-05-31'), measurementValue: 44114.73, reportDescription: 'Energia elétrica — Abr-Mai/2026. Faturas conferidas, consumo dentro da variação contratual.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-06-10T09:00:00Z'), createdAt: new Date('2026-06-05T10:00:00Z') },
      { contractId: CT['c03'], fiscalId: U.f03, periodStart: new Date('2026-05-01'), periodEnd: new Date('2026-06-30'), measurementValue: 86400, reportDescription: 'Remoção hospitalar — Mai-Jun/2026. Registros de atendimentos conferidos.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-07-08T11:00:00Z'), createdAt: new Date('2026-07-03T10:00:00Z') },
      { contractId: CT['c09'], fiscalId: U.f09, periodStart: new Date('2026-01-01'), periodEnd: new Date('2026-01-31'), measurementValue: 77000, reportDescription: 'Transporte Jan/2026. Manifesto de cargas e comprovantes de entrega conferidos.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-02-18T15:00:00Z'), createdAt: new Date('2026-02-14T10:00:00Z') },
      { contractId: CT['c11'], fiscalId: U.f11, periodStart: new Date('2026-03-01'), periodEnd: new Date('2026-03-31'), measurementValue: 40500, reportDescription: 'ERP Mar/2026. Disponibilidade do sistema verificada: 99,2%.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-04-20T11:00:00Z'), createdAt: new Date('2026-04-16T09:00:00Z') },
      { contractId: CT['c05'], fiscalId: U.f05, periodStart: new Date('2026-04-01'), periodEnd: new Date('2026-04-30'), measurementValue: 66542, reportDescription: 'Vale alimentação Abr/2026. Créditos efetuados em D+1 conforme contrato.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-05-22T14:00:00Z'), createdAt: new Date('2026-05-18T10:00:00Z') },
      { contractId: CT['c14'], fiscalId: U.f13, periodStart: new Date('2026-04-01'), periodEnd: new Date('2026-05-31'), measurementValue: 80000, reportDescription: 'Telecomunicações — 2º bimestre 2026. SLA: 99,7%. Conferido.', status: MeasurementStatus.APPROVED, approvedById: U.gestor, approvalDate: new Date('2026-06-18T10:00:00Z'), createdAt: new Date('2026-06-14T09:00:00Z') },
      { contractId: CT['c06'], fiscalId: U.f06, periodStart: new Date('2026-05-01'), periodEnd: new Date('2026-06-30'), measurementValue: 51000, reportDescription: 'Portaria e limpeza — Mai-Jun/2026. Escala e relatório de supervisão conferidos.', status: MeasurementStatus.PENDING_GESTOR, createdAt: new Date('2026-07-10T10:00:00Z') },
    ],
  });
  ...
  await prisma.contractAlteration.create({
    data: {
      contractId: CT['c04'], type: AlterationType.ADDENDUM_VALUE_INCREASE,
      ...
      status: AlterationStatus.APPROVED, requestedById: U.f04, reviewedById: U.gestor,
  ...
  await prisma.systemAlert.createMany({
    data: [
      { contractId: CT['c01'], type: AlertType.OCCURRENCE_CRITICAL, message: 'Ocorrência de alta gravidade: Inconformidade em exames audiométricos no Contrato 032/2023 (SESI).', targetRole: UserRole.GESTOR, isRead: false, createdAt: new Date('2026-05-28T10:15:00Z') },
      { contractId: CT['c01'], type: AlertType.MEASUREMENT_PENDING, message: 'Medição pendente de homologação no valor de R$ 64.575,00 para o Contrato 032/2023 (SESI).', targetRole: UserRole.GESTOR, isRead: false, createdAt: new Date('2026-05-20T17:30:00Z') },
    ],
  });
