/**
 * Motor de derivação da Central de Fiscalização do SIGFIS (cópia canônica).
 *
 ...
 *      Diagnóstico).
 *
 * Espelhado em `frontend/src/lib/fiscalizacao-engine.ts` — mesmas funções,
 ...
 * de paridade por fixture (`fiscalizacao-engine.parity.spec.ts` +
